            ...
            <div className="flex flex-col items-center gap-8">
              ...
              <div className="w-full space-y-6">
                <div className="text-center mb-4">
                  <h2 className="font-serif text-4xl md:text-5xl font-bold text-white text-center drop-shadow-md">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="flex items-center justify-center">
                    <h2 className="font-serif text-xl md:text-2xl font-semibold text-white text-center drop-shadow-md">
                      {question.question}
                    </h2>
                  </div>
